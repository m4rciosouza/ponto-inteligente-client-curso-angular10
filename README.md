...
Código cliente Angular 10 do sistema de ponto inteligente.
...
```
git clone https://github.com/m4rciosouza/ponto-inteligente-client-curso-angular10.git
cd ponto-inteligente-client-curso-angular10
